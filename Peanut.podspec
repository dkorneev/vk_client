...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of Peanut
  #
  #                   * Markdonw format.
  ...
  #
  s.author       = { "Denis Korneev" => "den.kor.90@gmail.com" }
  # s.authors      = { "Denis Korneev" => "den.kor.90@gmail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Denis Korneev', 'other author'
